...
const FinancialSection = () => {
  ...
  useGSAP(() => {
    gsap.utils.toArray(".financialBottom").forEach((section) => {
      gsap.to(section, {
        scrollTrigger: {
          trigger: section,
          start: "top 85%",
    ...
    <>
        <div className="w-full bg-[#090909] min-h-[100vh] ">
             <div className="w-full min-h-[100vh] overflow-hidden  rounded-b-[50%] pt-10 border-b border-white/30  shadow-[0_8px_10px_-5px_rgba(255,255,255,0.25)]  ">
               <section className="financialCards opacity-0 w-full min-h-screen bg-[#090909] text-white pt-40 px-6 md:px-16">
               ...
               <div className="w-full h-[80vh] pt-20   ">
                 <div className="financialBottom translate-y-[35%] opacity-0 w-full h-[30vh] bg-[#77777787] px-30 flex items-center justify-between">
                   <div>
                 ...
                 <div className="financialBottom translate-y-[-40%] opacity-0 w-[58%] h-[24vh] rounded-2xl mt-[-2.5vw]  ml-[22vw]  p-8 flex items-center border border-white/30 shadow-[0_4px_15px_rgba(255,255,255,0.4)]">
                   <div className="w-1/2">
                     {" "}
