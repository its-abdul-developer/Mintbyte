...
const Auxillaryofferings = () => {
  ...
  return (
    <>
      <AllPagesTopContent
        title1="Auxillary offerings "
        title2=""
        title3="Visualization & Rendering"
        title4=""
        flex="hidden"
        flex2="hidden"
        height="h-[115vh]"
        description="Auxiliary Offerings are additional services or products designed to complement primary offerings, enhancing value and user experience. "
...
export default Auxillaryofferings;
