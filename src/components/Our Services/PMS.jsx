  ...
  return (
    <>
      <AllPagesTopContent
        title1="PMS"
        title2="Elevate your"
        title3="Wealth with our,"
        title4="Expertise"
        flex="hidden"
        flex2="hidden"
        height="h-[115vh]"
        description="Are you navigating the complexities of financial markets to curate a personalised portfolio?Your search ends at Mintbyte, where we deliver a diverse suite of tailored PMS solutions to help you grow, preserve, and optimize your wealth."
        // homeDescription="hidden"
        homeVideo="/videos/video10.mp4"
      />
        ...
        <div className="w-full h-[55vh] px-30 overflow-hidden  flex justify-between mt-10">
          ...
          <div className="w-[45%] h-full  p-10 text-xl">
            <p className="my-10">
              ...
              investor's portfolio based on their specific financial goals and
              risk tolerance. PMS offers a personalized approach, allowing for
              customized investment strategies and potentially higher returns
              compared to traditional investment options. However, PMS typically
              requires a higher minimum investment and involves higher fees.
            </p>
        ...
        <div className="w-full pb-10">
          <div className="text-center pt-20 flex flex-col items-center justify-center">
            ...
            <p className="text-center w-[40%] mt-5">
              Mintbyte's Portfolio Management Services (PMS) offer personalized
              investment solutions tailored to your financial goals and risk
              appetite:
            </p>
          </div>
            ...
            <div className="w-full  my-15 flex gap-10 justify-between px-40">                                                     
              <div className="w-1/2 leading-[1.8] rounded-2xl p-8 border border-white/30 shadow-[0_4px_15px_rgba(255,255,255,0.4)]">
                ...
                <p className="text-lg w-[85%]">
                  Focused on long-term capital appreciation through high-growth
                  stocks.
                </p>
                <p className="text-lg w-[85%]">
              ...
              <div className="w-1/2 flex flex-col gap-10">
                <div className="w-full  h-full  rounded-2xl p-8 border border-white/30 shadow-[0_4px_15px_rgba(255,255,255,0.4)]">
                  ...
                  <p className="text-lg w-[85%]">
                    This product is designed for risk-averse investors seeking
                    steady income and capital preservation. It includes
                    government bonds, corporate debt, and fixed-income
                    securities.
                  </p>
                </div>
                <div className="w-full h-full  rounded-2xl p-8 border border-white/30 shadow-[0_4px_15px_rgba(255,255,255,0.4)]">
                  ...
                  <p className="text-lg w-[85%]">
                    Investments focused on specific industries or emerging
                    themes – Technology, Healthcare, ESG (Environmental, Social,
                    and Governance).
                  </p>
                </div>
              </div>
            ...
            <div className="w-full h-[30vh] flex gap-10 justify-between px-40">
              <div className="w-1/2 h-full  rounded-2xl p-8 border border-white/30 shadow-[0_4px_15px_rgba(255,255,255,0.4)]">
                ...
                <p className="text-lg w-[90%]">
                  A balanced approach combining equities and fixed-income
                  instruments – Ideal for investors looking for moderate risk
              ...
              <div className="w-1/2 h-full  rounded-2xl p-8 border border-white/30 shadow-[0_4px_15px_rgba(255,255,255,0.4)]">
                ...
                <p className="text-lg w-[85%]">
                  Focuses on undervalued companies with solid fundamentals for
              ...
              <div className="w-1/2 h-full  rounded-2xl p-8 border border-white/30 shadow-[0_4px_15px_rgba(255,255,255,0.4)]">
                ...
                <p className="text-lg w-[85%]">
                  Target companies with high growth potential in expanding
              ...
              <div className="  flex flex-col gap-10">
                <div className="w-full  h-full rounded-2xl p-8 border border-white/30 shadow-[0_4px_15px_rgba(255,255,255,0.4)]">
                  ...
                  <p className="text-xl w-[85%]">
                    Prioritizes investments in companies offering consistent and
                ...
                <div className="w-full h-full  rounded-2xl p-8 border border-white/30 shadow-[0_4px_15px_rgba(255,255,255,0.4)]">
                  ...
                  <p className="text-xl w-[85%]">
                    Combines equities, debt, commodities, and alternative
                    investments for maximum diversification.
                  </p>
                </div>
              </div>
              <div className="w-1/2 flex flex-col gap-10">
                <div className="w-full  h-full  rounded-2xl p-8 border border-white/30 shadow-[0_4px_15px_rgba(255,255,255,0.4)]">
                  ...
                  <p className="text-xl w-[85%]">
                    Investing a substantial amount of capital into financial
                ...
                <div className="w-full h-full  rounded-2xl p-8 border border-white/30 shadow-[0_4px_15px_rgba(255,255,255,0.4)]">
                  ...
                  <p className="text-lg w-[85%]">
                    Investing a substantial amount of capital into financial
                    instruments all at once, as opposed to staggered
                    contributions over time – surplus funds from bonuses,
