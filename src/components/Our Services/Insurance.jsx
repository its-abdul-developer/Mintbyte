  ...
  return (
    <>
      <AllPagesTopContent
        ...
        flex2="hidden"
        height="h-[115vh]"
        description="Insurance is not just a financial safety net—it’s a promise of security, a safeguard against life’s unpredictability."
        homeVideo="/videos/video16.mp4"
      />
        ...
        <div className="w-full pt-30">
          ...
          <div className="w-full  p-30 overflow-hidden  flex justify-between mt-10">
            ...
            <div className="w-[45%] h-full  pt-40 text-xl flex flex-col justify-center items-start">
              ...
              <p className="my-10">
                Whether safeguarding your health, securing your property, or
                mitigating unforeseen risks, we are here to help you navigate
                life confidently.
              </p>
          ...
          <div className="w-full h-[55vh]  mt-10 rounded-2xl flex gap-10 border border-white/30 shadow-[0_4px_15px_rgba(255,255,255,0.4)]">
            <div className="w-1/2 h-full p-10 ">
              <div className="w-full h-full rounded-2xl overflow-hidden border border-white/30 shadow-[0_4px_15px_rgba(255,255,255,0.4)]">
                <img
                  className="w-full h-full object-cover"
                  src="/images/groups/insurance2.png"
                  alt=""
                />
              </div>
            </div>
            <div className="w-1/2 h-full p-15 flex flex-col gap-6 items-start">
              ...
              <div className="w-full flex p-4 items-center gap-10 rounded-xl border border-white/30 shadow-[0_4px_20px_rgba(255,255,255,0.4)]">
                ...
                <div>
                  <p>
                    Term Life Insurance: High coverage at affordable premiums
                    for pure protection
                  </p>
                </div>
              </div>
              <div className="w-full flex p-4 items-center gap-10 rounded-xl border border-white/30 shadow-[0_4px_20px_rgba(255,255,255,0.4)]">
                ...
                <div>
                  <p>
                    Savings & Endowment Plans: Life cover combined with wealth
                    accumulation for long-term goals.
                  </p>
                </div>
              </div>
              <div className="w-full flex p-4 items-center gap-10 rounded-xl border border-white/30 shadow-[0_4px_20px_rgba(255,255,255,0.4)]">
                ...
                <div>
                  <p>
                    Unit Linked Insurance Plans (ULIPs): Market-linked returns
          ...
          <div className="w-full h-[55vh]  mt-10 rounded-2xl flex gap-10 border border-white/30 shadow-[0_4px_15px_rgba(255,255,255,0.4)]">
            <div className="w-1/2 h-full p-15 flex flex-col gap-6 items-start">
              ...
              <div className="w-full flex p-4 items-center gap-10 rounded-xl border border-white/30 shadow-[0_4px_20px_rgba(255,255,255,0.4)]">
                ...
                />
                <div>
                  <p>Top-Up and Super Top-Up Coverage</p>
                </div>
              </div>
            </div>
            <div className="w-1/2 h-full p-10 ">
          ...
          <div className="w-full h-[55vh]  mt-10 rounded-2xl flex gap-10 border border-white/30 shadow-[0_4px_15px_rgba(255,255,255,0.4)]">
            <div className="w-1/2 h-full p-10 ">
              <div className="w-full h-full rounded-2xl overflow-hidden border border-white/30 shadow-[0_4px_15px_rgba(255,255,255,0.4)]">
                <img
                  className="w-full h-full object-cover"
                  src="/images/groups/insurance3.png"
                  alt=""
                />
              </div>
            </div>
            <div className="w-1/2 h-full p-15 flex flex-col gap-6 items-start">
              ...
              <div className="w-full flex p-4 items-center gap-10 rounded-xl border border-white/30 shadow-[0_4px_20px_rgba(255,255,255,0.4)]">
                ...
                />
                <div>
                  <p>Add-Ons: Zero Depreciation, Engine Protection</p>
                </div>
              </div>
            </div>
          </div>
          <div className="w-full h-[55vh]  mt-10 rounded-2xl flex gap-10 border border-white/30 shadow-[0_4px_15px_rgba(255,255,255,0.4)]">
            <div className="w-1/2 h-full p-15 flex flex-col gap-6 items-start">
              ...
              <div className="w-full flex p-4 items-center gap-10 rounded-xl border border-white/30 shadow-[0_4px_20px_rgba(255,255,255,0.4)]">
                ...
                <div>
                  <p>
                    Your home is your sanctuary protect it from risks like fire,
                    natural calamities, theft, and unforeseen damages.
                  </p>
                </div>
              </div>
              <div className="w-full flex p-4 items-center gap-10 rounded-xl border border-white/30 shadow-[0_4px_20px_rgba(255,255,255,0.4)]">
              ...
              <div className="w-full flex p-4 items-center gap-10 rounded-xl border border-white/30 shadow-[0_4px_20px_rgba(255,255,255,0.4)]">
                ...
                />
                <div>
                  <p>Insurance for Valuables and Appliances</p>
                </div>
              </div>
            </div>
            <div className="w-1/2 h-full p-10 ">
              <div className="w-full h-full rounded-2xl overflow-hidden border border-white/30 shadow-[0_4px_15px_rgba(255,255,255,0.4)]">
                <img
                  className="w-full h-full object-cover"
                  src="/images/groups/insurance4.png"
                  alt=""
                />
              </div>
            </div>
          ...
          <div className="w-full h-[55vh]  mt-10 rounded-2xl flex gap-10 border border-white/30 shadow-[0_4px_15px_rgba(255,255,255,0.4)]">
            <div className="w-1/2 h-full p-10 ">
              <div className="w-full h-full rounded-2xl overflow-hidden border border-white/30 shadow-[0_4px_15px_rgba(255,255,255,0.4)]">
                <img
                  className="w-full h-full object-cover"
                  src="/images/groups/insurance5.png"
                  alt=""
                />
              </div>
            </div>
            <div className="w-1/2 h-full p-15 flex flex-col gap-6 items-start">
              ...
              <div className="w-full flex p-4 items-center gap-10 rounded-xl border border-white/30 shadow-[0_4px_20px_rgba(255,255,255,0.4)]">
                ...
                <div>
                  <p>
                    Explore world confidently, knowing you’re covered for
                    medical emergencies, cancellations & more.
                  </p>
                </div>
              </div>
              <div className="w-full flex p-4 items-center gap-10 rounded-xl border border-white/30 shadow-[0_4px_20px_rgba(255,255,255,0.4)]">
              ...
              <div className="w-full flex p-4 items-center gap-10 rounded-xl border border-white/30 shadow-[0_4px_20px_rgba(255,255,255,0.4)]">
                ...
                />
                <div>
                  <p>Special Coverage for Students and Frequent Flyers</p>
                </div>
              </div>
            </div>
          </div>
          <div className="w-full h-[55vh]  mt-10 rounded-2xl flex gap-10 border border-white/30 shadow-[0_4px_15px_rgba(255,255,255,0.4)]">
            <div className="w-1/2 h-full p-15 flex flex-col gap-6 items-start">
              ...
              <div className="w-full flex p-4 items-center gap-10 rounded-xl border border-white/30 shadow-[0_4px_20px_rgba(255,255,255,0.4)]">
                ...
                <div>
                  <p>
                    Keep your business secured with customized insurance plans
                    to protect your assets, employees, & operations
                  </p>
                </div>
              </div>
              <div className="w-full flex p-4 items-center gap-10 rounded-xl border border-white/30 shadow-[0_4px_20px_rgba(255,255,255,0.4)]">
            ...
            <div className="w-1/2 h-full p-10 ">
              <div className="w-full h-full rounded-2xl overflow-hidden border border-white/30 shadow-[0_4px_15px_rgba(255,255,255,0.4)]">
                <img
                  className="w-full h-full object-cover"
                  src="/images/groups/insurance6.png"
                  alt=""
                />
              </div>
            </div>
          ...
          <div className="w-full h-[55vh]  mt-10 rounded-2xl flex gap-10 border border-white/30 shadow-[0_4px_15px_rgba(255,255,255,0.4)]">
            <div className="w-1/2 h-full p-5 ">
              <div className="w-full h-full rounded-2xl overflow-hidden border border-white/30 shadow-[0_4px_15px_rgba(255,255,255,0.4)]">
                <img
                  className="w-full h-full object-cover"
                  src="/images/groups/insurance7.png"
                  alt=""
                />
              </div>
            </div>
            <div className="w-1/2 h-full p-15 flex flex-col gap-6 items-start">
              ...
              <div className="w-full flex p-4 items-center gap-10 rounded-xl border border-white/30 shadow-[0_4px_20px_rgba(255,255,255,0.4)]">
                ...
                />
                <div>
                  <p>Crop Insurance for agricultural stability</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="w-full min-h-[180vh] py-20 transition-all ease-linear  border border-white/30  shadow-[0_8px_15px_-5px_rgba(255,255,255,0.25)] rounded-[50%]">
            <div className=" w-full h-[70vh] px-[4vw]">
              <div className="relative pt-30 text-center">
                ...
                <svg
                  className=" absolute left-[70%] top-[25%]  text-green-400"
                  width="117"
                  height="117"
                  viewBox="0 0 117 117"
                  fill="white"
              ...
              <div className="w-full h-[40vh] px-30 mt-20  flex gap-10">
                <div className="w-1/2 h-full rounded-xl flex flex-col items-center justify-center border border-white/30 shadow-[0_4px_15px_rgba(255,255,255,0.4)]">
                  ...
                  <p className="text-lg mx-20 text-center">
                    Understand your unique needs and recommend tailored
                    insurance solutions
                  </p>
                </div>
                <div className="w-1/2 h-full rounded-xl flex flex-col items-center justify-center border border-white/30 shadow-[0_4px_15px_rgba(255,255,255,0.4)]">
                  ...
                  <p className="text-lg mx-20 text-center">
                    Access plans from top insurers to identify the best coverage
                    and value
                  </p>
                </div>
                <div className="w-1/2 h-full rounded-xl flex flex-col items-center justify-center border border-white/30 shadow-[0_4px_15px_rgba(255,255,255,0.4)]">
                  ...
                  <h2 className="text-4xl font-medium my-5">Claims Support</h2>

                  <p className="text-lg mx-20 text-center">
                    Enjoy seamless claims management with dedicated assistance
                    every step of the way
                  </p>
                </div>
              </div>
              <div className="text-center pt-10">
                <button className="px-8 py-[1.4vh] mt-15 rounded-[50px] bg-[#33BC24] text-white hover:bg-[#00CC66] hover:shadow-[0_0_10px_#00FF88] transition-all duration-300 cursor-pointer">
                  Get Started
                </button>
              </div>
              <div className="w-full h-[30vh] mt-[6vw] relative bg-[#777777ed] rounded-xl px-20 flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xl mt-5">
                    Get a personalized insurance quote today for a worry-free
                    tomorrow
                  </p>
                </div>
                <div className="">
